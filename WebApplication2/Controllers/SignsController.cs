...
namespace WebApplication2.Controllers
{
    public class SignsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CID,CustomarID,Name,Phone,Email,Password")] Sign sign)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CID,CustomarID,Name,Phone,Email,Password")] Sign sign)
        {
            if (ModelState.IsValid)
            {
